...
INSERT INTO auth.oauth_client_details (client_id, client_secret, authorities, authorized_grant_types,  resource_ids, scope) VALUES ('trusted-client', 'secret', 'TRUSTED_CLIENT', 'client_credentials,password', 'auth,example,requisition,notification,referencedata', 'read,write');
